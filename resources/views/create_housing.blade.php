...
<body>
  <div class="zuzus">
    ...
    @csrf
      <div class="container p-5 mt-4 mb-4" style="background-color: white;">
        <h1 class="text-center mb-lg-5">Create a Post</h1>

        <div class="form-floating mb-3">
          <input type="text" name='title' class="form-control" id="totalsqft" placeholder="are in sq.ft">
        ...
        <div class="form-floating mb-3">
          <input type="number" name='totalsqft' class="form-control" id="totalsqft" placeholder="are in sq.ft">
          <label for="totalsqft">Total Square Feet</label>
          <span id="sqft" class=" text-danger font-weight-bold"></span>
        </div>

        <div class="form-floating mb-3">
          <input name="city" type="text" class="form-control" id="city" placeholder="city name ">
          <label for="floatingInput">City</label>
          <span id="cityerror" class=" text-danger font-weight-bold"></span>
        </div>

        <div class="form-floating mb-3">
          <input name="location" type="text" class="form-control" id="location" placeholder="Location name">
        ...
        <div class="form-floating mb-3">
          <input name="address" type="text" class="form-control" id="address" placeholder="Address name">
          <label for="floatingInput">Address</label>
          <span id="addresserror" class=" text-danger font-weight-bold"></span>
        </div>

        <div class="form-floating mb-3">
          <input name="price" type="number" class="form-control" id="address" placeholder="Address name">
          <label for="floatingInput">Price</label>
          <span id="addresserror" class=" text-danger font-weight-bold"></span>
        </div>

        <div class="form-floating mb-3">
          <input name="phonenumber" type="number" class="form-control" id="no" placeholder="phone number">
        ...
        <div class="mb-3">
          ...
          <span id="wrongfile" class=" text-danger font-weight-bold"></span>
        </div>


        <button type="submit" class="btn btn-dark mt-lg-4 gg" onclick="validation()">Submit</button>
  ...
  <script>
    function validation() {
      ...
      var fld=document.getElementById('formFile')
      ...
      if(!/(\.bmp|\.gif|\.jpg|\.jpeg)$/i.test(fld.value)) {
        ...
        document.getElementById("wrongfile").innerHTML = "Wrong file type. Can only attach BMP, GIF, JPG or JPEG type";
