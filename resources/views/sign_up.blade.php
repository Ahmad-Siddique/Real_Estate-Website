    ...
    <div class="container  p-5 mt-4" style="background-color: white;">
      <h1 class="text-center mb-lg-5">SIGN UP</h1>
        ...
        <div class="form-floating mb-3">
          ...
          <label for="floatingPassword1">Re-Type Password</label>
          <span id="repasserror" class=" text-danger font-weight-bold">
          </span>
        </div>
        ...
        <div class="form-floating ">
          <input type="number" class="form-control" id="no" placeholder="Password" required>
          <label for="no">Phone Number</label>
          <span id="phoneerror" class=" text-danger font-weight-bold">
          </span>
        </div>
        <button type="submit" class="btn btn-dark mt-lg-4"  onclick="validation()"> Sign up</button>
      </form>        
    </div>
    ...
    <div class="container">
      <div class="row pt-3 pb-3">
        ...
        <div class="col-lg-4 col-12 text-lg-center mt-3">
          ...
          <a style="color:white;" href="www.linkedin.com"><i class="fa fa-linkedin-square"
              style="font-size:24px"></i></a>
